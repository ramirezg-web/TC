...
//		}
	...
	public String nTwice(String str, int n) {
		...
		String secondChar = str.substring(str.length() - n );
	...
	public String twoChar(String str, int index) {
		...
		String firstChar = str.substring(index, index + 2);

		//if index is too bif return first two chars
		//if ( index > str.length()) {
		//return str.substring(0 , 2);
		//}
	...
	public String frontTimes(String str, int n) {
		...
		int i = 1;
		String full = frontThree;
		while ( i < n) {
			full = full + frontThree;
			i++;
		}
		return full;	}
	...
	public int countXX(String str) {
		...
		while ( j < str.length() +1) {
			if (str.substring(i, j).contains("xx")) {
				count++;
			}
			j++;
			i++;
	...
	public int last2(String str) {
		...
		for (int i = 0 ; i < str.length() - 2 ; i++) {
			String partialStr = str.substring(i, i+2);
			if (partialStr.equals(end)) {
				count++;
			}
		}
		return count;	}
...
//		return result;
		...
		midStr = midStr.replaceAll("x", "");
		return firstChar + midStr + lastChar;
	}
